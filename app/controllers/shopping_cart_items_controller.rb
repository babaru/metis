class ShoppingCartItemsController < ApplicationController
  ...
  def index
    @shopping_cart_items_grid = initialize_grid(ShoppingCartItem)

    respond_to do |format|
      format.html # index.html.erb
      format.json { render json: @shopping_cart_items_grid }
    end
  end
  ...
  def create
    ...
    respond_to do |format|
      if @shopping_cart_item.save
        format.html { redirect_to shopping_cart_item_path(@shopping_cart_item), notice: 'Shopping cart item was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @shopping_cart_item.update_attributes(params[:shopping_cart_item])
        format.html { redirect_to shopping_cart_item_path(@shopping_cart_item), notice: 'Shopping cart item was successfully updated.' }
