...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.item :page_spots, t('navigation.spots'), Website.count > 0 ? website_data_path(Website.first, :spot) : nil, link: {icon: 'icon-trello'}, highlights_on: /websites/ do |spots|
